...
rustPlatform.buildRustPackage rec {
  ...
  cargoLock = {
    ...
    outputHashes = {
      ...
      "tree-sitter-bash-0.19.0" = "sha256-QkH5rI9/7x6L7e3YIwDMdSbBHOGhhC6LTHfasS7wX9U=";
      ...
      "tree-sitter-glsl-0.1.3" = "sha256-x3UM99mxy1+YjdjscVKWEo8gpV15WZYHzu/Yehelips=";
      ...
      "tree-sitter-yaml-0.0.1" = "sha256-9CUaHYAGPzysfFkiIP/l7E4TO0h3GLelYejp/BxcoEk=";
