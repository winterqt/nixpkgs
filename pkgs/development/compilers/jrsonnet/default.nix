...
rustPlatform.buildRustPackage rec {
  ...
  cargoLock = {
    ...
    outputHashes = {
      ...
      "clap_derive-3.0.0-beta.2" = "sha256-BaLzm2JZEicktfsCIXQipHtEKlEv2lBktfvHP58rjeM=";
      "clap_generate-3.0.0-beta.2" = "sha256-BaLzm2JZEicktfsCIXQipHtEKlEv2lBktfvHP58rjeM=";
    };
  };
