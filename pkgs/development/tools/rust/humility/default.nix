...
rustPlatform.buildRustPackage rec {
  ...
  cargoLock = {
    ...
    outputHashes = {
      ...
      "capstone-sys-0.14.0" = "sha256-x0p005W6u3QsTKRupj9HEg+dZB3xCXlKb9VCKv+LJ0U=";
      "hidapi-1.4.1" = "sha256-cBgK1k6xflDb8G3Rqf46TrLv2yLvS6R9S1COUlfrCCg=";
      ...
      "libusb1-sys-0.5.0" = "sha256-VZbxhlbjiYWuSBq0Zg/rM0Ja+feFEFCUPTWv/9wVdmk=";
      ...
      "probe-rs-target-0.12.0" = "sha256-L2kQNAdSvv5x1goELuy3pZZzmoUDc4tMX3OJ7A5rAD0=";
      ...
      "vsc7448-types-0.1.0" = "sha256-otNLdfGIzuyu03wEb7tzhZVVMdS0of2sU/AKSNSsoho=";
    };
  };
